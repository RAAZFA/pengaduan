        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="<?= base_url('auth/simpan') ?>" method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="email" name="nama" placeholder="Enter your name" />
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="email" name="alamat" placeholder="Enter your Address" />
                </div>
